...
public static partial class Module
{
    ...
    /// </summary>
    /// <remarks>
    /// 该类型采用“返回新值”的不可变风格：所有变更方法（Add/Sub/Set/SetMax）都会返回一个新的 <see cref="Stamina" />。
    ...
    public partial struct Stamina
    {
        ...
        /// <summary>
        /// 增加精力值（不会超过 <see cref="Max" />）。
        /// </summary>
        /// <param name="amount">增加量（小于等于 0 将不产生变化）。</param>
        /// <returns>增加后的新 <see cref="Stamina" />。</returns>
        ...
        /// <returns>扣减后的新 <see cref="Stamina" />。</returns>
        ...
        /// <summary>
        /// 设置当前精力值（会被夹紧到合法区间 <c>[0, Max]</c>）。
        /// </summary>
        /// <param name="value">要设置的当前值。</param>
        /// <returns>设置后的新 <see cref="Stamina" />。</returns>
        ...
        /// <summary>
        /// 修改最大精力值，并在必要时将 <see cref="Current" /> 夹紧到新的最大值。
        /// </summary>
        /// <param name="newMax">新的最大值（小于 0 会被视为 0）。</param>
        /// <returns>修改后的新 <see cref="Stamina" />。</returns>
